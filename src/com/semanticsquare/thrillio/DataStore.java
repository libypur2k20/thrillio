...
public class DataStore {
    ...
    public static final int MAX_BOOKMARK_TYPES = 3;
    public static final int MAX_BOOKMARKS_PER_TYPE = 5;
    ...
    private static Bookmark[][] bookmarks = new Bookmark[MAX_BOOKMARK_TYPES][MAX_BOOKMARKS_PER_TYPE];
    public static Bookmark[][] getBookmarks() {
        return bookmarks;
    }

    private static UserBookmark[] userBookmarks = new UserBookmark[TOTAL_USER_COUNT * MAX_BOOKMARKS_PER_USER];
    private static int userBookmarkIndex;
